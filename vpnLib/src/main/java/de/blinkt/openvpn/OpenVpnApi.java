...
public class OpenVpnApi {
    ...
    static void startVpnInternal(Context context, String config, String name, String username, String password, String priKeyPasswd, List<String> bypassPackages) throws RemoteException {
